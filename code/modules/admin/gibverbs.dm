...
/obj/bantyson/
	...
	proc/banproc()
		...
		if(tysontarget2?.client)
			...
			logTheThing("admin", call_source:client, tysontarget2, "has tysonbanned [constructTarget(tysontarget2,"admin")]. Reason: [tysonreason] and he couldn't escape the tyson. This will be removed in [tysonmins2] minutes.")
			logTheThing("diary", call_source:client, tysontarget2, "has tysonbanned [constructTarget(tysontarget2,"diary")]. Reason: [tysonreason] and he couldn't escape the tyson. This will be removed in [tysonmins2] minutes.", "admin")
			message_admins("<span class='internal'>[call_source?.client?.ckey] has tysonbanned [tysontarget2.ckey].<br>Reason: [tysonreason] and he couldn't escape the tyson.<br>This will be removed in [tysonmins2] minutes.</span>")
...
/obj/gibtyson/
	...
	proc/gibproc()
		...
		if (get_dist(src, src.tysontarget2) <= 1)
			...
			playsound(src.loc, 'sound/impact_sounds/generic_hit_3.ogg', 30, 1, -2)
			logTheThing("admin", call_source:client, tysontarget2, "tysongibbed [constructTarget(tysontarget2,"admin")]")
			logTheThing("diary", call_source:client, tysontarget2, "tysongibbed [constructTarget(tysontarget2,"diary")]", "admin")
			message_admins("<span class='internal'>[call_source?.client?.ckey] has tysongibbed [tysontarget2] ([tysontarget2.ckey]).</span>")
			tysontarget2.gib()
			sleep(0.5 SECONDS)
