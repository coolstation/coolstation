/datum/admins
	...
	proc/show_pref_window(mob/user)
		...
		HTML += "<b>Hide Popup Verbs?: <a href='byond://?src=\ref[src];action=toggle_popup_verbs'>[(src.popuptoggle ? "Yes" : "No")]</a></b><br>"
		...
		if (src.owner:holder:level >= LEVEL_PA)
			HTML += "<b>Hide Atom Verbs \[old\]?: <a href='byond://?src=\ref[src];action=toggle_atom_verbs'>[(src.animtoggle ? "Yes" : "No")]</a></b><br>"
		HTML += "<b>Hide Attack Alerts?: <a href='byond://?src=\ref[src];action=toggle_attack_messages'>[(src.attacktoggle ? "Yes" : "No")]</a></b><br>"
