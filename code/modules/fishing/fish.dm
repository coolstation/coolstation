...
/obj/item/fish/pufferfish
	name = "pufferfish"
	desc = "Considered a delicacy, it's quite dangerous unless properly prepared."
	icon_state = "pufferfish"
	inhand_color = "#A6B967"
	fillet_type = /obj/item/reagent_containers/food/snacks/ingredient/meat/fugu
	var/liver_type = /obj/item/reagent_containers/food/snacks/ingredient/meat/puffer_liver
