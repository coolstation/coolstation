...
var/global/list/soundCache = list(
	...
	"sound/misc/talk/cow.ogg" = 'sound/misc/talk/fert.ogg',\
 	"sound/misc/talk/cow_ask.ogg" = 'sound/misc/talk/fert_ask.ogg',\
 	"sound/misc/talk/cow_exclaim.ogg" = 'sound/misc/talk/fert_exclaim.ogg',\
