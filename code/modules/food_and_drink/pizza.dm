/obj/item/reagent_containers/food/snacks/ingredient/pizza_base
	...
	proc/bake_pizza(var/matter_eater_fake_bake = FALSE)
		...
		/*if(length(temp_food_effects) > 4) // TO DO - re-enable after porting cmp_numeric_dsc etc
...
/obj/item/reagent_containers/food/snacks/pizza
	...
	var/slice_amount = 6
	var/slice_product = /obj/item/reagent_containers/food/snacks/pizzaslice
	...
	proc/make_slices(var/mob/user)
		...
		var/amount_to_transfer = src.reagents.total_volume / makeslices
		. = list()
		while (makeslices > 0)
