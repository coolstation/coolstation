...
/datum/targetable/press_x_to_shaun
	...
	cast()
		...
		if(shaun == 1)
			usr.say("SHAUN!")
			playsound(usr.loc, "sound/misc/funny/Shaun1.ogg", 50, 2)
		else if(shaun == 2)
			usr.say("SHAUN!!")
			playsound(usr.loc, "sound/misc/funny/Shaun2.ogg", 50, 2)
		else if(shaun == 3)
			usr.say("SHAAAAAAAAAUN!!!")
			playsound(usr.loc, "sound/misc/funny/Shaun3.ogg", 50, 2)
		else if(shaun == 4)
			usr.say("SHAUN WHERE ARE YOU?!")
			playsound(usr.loc, "sound/misc/funny/Shaun4.ogg", 50, 2)
