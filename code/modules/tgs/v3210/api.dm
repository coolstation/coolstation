...
/datum/tgs_api/v3210/ChatTargetedBroadcast(datum/tgs_message_content/message, admine_only)
	message = UpgradeDeprecatedChatMessage(message)
	ExportService("[admine_only ? SERVICE_REQUEST_IRC_ADMIN_CHANNEL_MESSAGE : SERVICE_REQUEST_IRC_BROADCAST] [message.text]")
