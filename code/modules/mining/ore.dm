...
/datum/ore
	...
	var/hardness_mod = 0
	var/event_chance = 8
	///If 1, will not be randomly generated by magnet (but eligible on Z levels). Will appear in separate ore rarity lists on mining controls.
	///If 2, neither eligible for the magnet not Z level generation. Quantum telescope exclusives live here
	var/no_pick = 0
	///health this ore has when mining.
