...
///Transfers up to 250 charge between borg and APC cell
/obj/item/robojumper
	name = "cell cables"
...
///stores/places canisters/pumps/scrubbers as well as fluid tanks cause on Oshan the atmosphere is sometimes Wet
...
/obj/item/lamp_manufacturer
	...
	afterattack(atom/A, mob/user as mob, reach, params)
		if (removing_toggled)
			...
			SETUP_GENERIC_ACTIONBAR(user, src, 2 SECONDS, /obj/item/lamp_manufacturer/proc/remove_light, list(A, user), null, null, null, INTERRUPT_MOVE)
		...
		if (istype(A, /turf/floor))
			...
			playsound(user, "sound/machines/click.ogg", 50, 1)
			SETUP_GENERIC_ACTIONBAR(user, src, 2 SECONDS, /obj/item/lamp_manufacturer/proc/add_floor_light, list(A, user), null, null, null, INTERRUPT_MOVE)
			...
			playsound(user, "sound/machines/click.ogg", 50, 1)
			SETUP_GENERIC_ACTIONBAR(user, src, 2 SECONDS, /obj/item/lamp_manufacturer/proc/add_wall_light, list(A, B, user), null, null, null, INTERRUPT_MOVE)
