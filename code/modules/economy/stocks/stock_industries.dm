...
/datum/stock/industry/consumer
	...
	generateProductName(company)
		var/list/meat = list("chicken", "beef", "seal", "monkey", "goat", "insect", "pigeon", "human", "walrus", "brullbar", "bear", "horse", "turkey", "pork", "shellfish", "starfish", "mimic", "mothroach", "mystery")
