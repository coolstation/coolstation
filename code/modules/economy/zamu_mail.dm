...
/obj/item/random_mail
	...
	attack_self(mob/M as mob)
		...
		logTheThing("station", M, "opened their [src] and got \a [prize] ([src.spawn_type]).")
		...
		if (prize && istype(prize, /obj/item))
			...
			logTheThing("station", M, "opened their [src] but nothing was there, how the fuck did this happen? It was supposed to be \a [src.spawn_type]!.")
...
var/global/mail_types_by_job = list(
	...
	/datum/job/logistics/cargotechnician = list(
		/obj/item/spacecash/hundred = 10,
		/obj/item/spacecash/fivehundred = 7,
		/obj/item/spacecash/random/tourist = 3,
		/obj/item/stamp/qm = 5,
...
//#endif
	...
	/obj/item/spacecash/random/tourist = 2,
	/obj/item/coin = 5,
