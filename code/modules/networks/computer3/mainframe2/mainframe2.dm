...
/obj/machinery/networked/mainframe/warm //intended for roundstart data (but if you still have the main tape you can swap that in)
	name = "Warm Site Mainframe"
	desc = "A mainframe computer, designated as the warm backup. It's pretty big, and still hot!"
	...
	//leave as is- copy original init
	...
	//note to self: need to define warm and cold site areas
/obj/machinery/networked/mainframe/cold //has no data and starts with nothing, needs a tape installed, etc.
	...
	//need to define storage with minimum bootstrap
	//see above re: area and APC
