...
/proc/get_bureau_name()
	...
	var/list/resource = list("Space Dolphin","Urine","Plasma","Paper","Tree","Human","Robot","AI","Asteroid","Ice","Lamp", "Bone", "Lotion", "Tissue", "Toilet Paper","Alien","Pants","Phasmid","Candy","Colored Pencil","Fish","Beer") //literally just throw whatever random shit you can think of
	var/list/fields = list("Pest Control","Paperwork","HR","Rationing","Frontier Census","Middle Management","[pick(resource)] Conservation","[pick(resource)] Management","Cooperation","integration","Alignment","Documentation","Time Management")
