...
proc/explosion_new(atom/source, turf/epicenter, power, brisance=1, angle = 0, width = 360, turf_safe = FALSE, no_effects = FALSE)
	explosions.explode_at(source, epicenter, power, brisance, angle, width, turf_safe, no_effects)
