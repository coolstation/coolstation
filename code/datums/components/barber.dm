...
/datum/component/toggle_tool_use/Initialize()
	...
	RegisterSignal(parent, list(COMSIG_ITEM_DROPPED, COMSIG_ITEM_PICKUP), PROC_REF(on_drop_or_pickup))
	RegisterSignal(parent, list(COMSIG_ITEM_ATTACK_SELF), PROC_REF(toggle_force_use_as_tool))
...
/datum/component/barber/haircut/Initialize()
	RegisterSignal(parent, list(COMSIG_ITEM_ATTACK_PRE), PROC_REF(do_haircut))

/datum/component/barber/shave
/datum/component/barber/shave/Initialize()
	RegisterSignal(parent, list(COMSIG_ITEM_ATTACK_PRE), PROC_REF(do_shave))
