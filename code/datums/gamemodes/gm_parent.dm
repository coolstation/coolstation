/datum/game_mode
	...
	var/escape_possible = 1		//for determining if players lose their held spacebux item on round end if they are able to "escape" in this mode. (we can probably just get rid of this, right?)
