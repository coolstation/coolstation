/datum/hud/wraith/poltergeist
	...
	New(M)
		...
		well_dist = create_screen("well_dist","Well Distance", 'icons/ui/wraith_ui.dmi', "poltergeist_cd", "EAST, NORTH-1", HUD_LAYER, tooltipTheme = "well_dist")
		leave_master = create_screen("leave_master","Leave Master", 'icons/ui/wraith_ui.dmi', "leave_master", "EAST, NORTH-2", HUD_LAYER, tooltipTheme = "well_dist")
