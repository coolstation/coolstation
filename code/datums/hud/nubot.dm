/datum/hud/nubot
	...
	var/mob/living/silicon/nubot/master
	var/icon/icon_hud = 'icons/ui/hud_nubot.dmi'
	...
	New(M)
		...
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_bg", "CENTER-3, SOUTH to CENTER+3, SOUTH", HUD_LAYER)
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_side", "CENTER-3, SOUTH+1 to CENTER+3, SOUTH+1", HUD_LAYER, SOUTH)
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_side", "CENTER-4, SOUTH+1", HUD_LAYER, SOUTHWEST)
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_side", "CENTER-4, SOUTH", HUD_LAYER, EAST)
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_side", "CENTER+4, SOUTH+1", HUD_LAYER, SOUTHEAST)
		create_screen("", "", 'icons/ui/hud_common.dmi', "hotbar_side", "CENTER+4, SOUTH", HUD_LAYER, WEST)

		mod1 = create_screen("mod1", "Tool", icon_hud, "toolslot", "CENTER-2, SOUTH", HUD_LAYER+1)

		create_screen("radio", "Radio", icon_hud, "radio", "CENTER+2, SOUTH", HUD_LAYER+1)
...
//		face = create_screen("face", "Customize Face", icon_hud, "custface", "CENTER+2, SOUTH", HUD_LAYER+1)
		intent = create_screen("intent", "Intent", icon_hud, "intent-[master.a_intent]", "CENTER-3, SOUTH", HUD_LAYER+1)
		...
		pda = create_screen("pda", "Cyborg PDA", 'icons/ui/hud_nubot.dmi', "pda", "EAST, NORTH-2.5", HUD_LAYER)
...
/mob/living/silicon/nubot
	updateStatusUi()
		if(src.hud && istype(src.hud, /datum/hud/nubot))
			var/datum/hud/nubot/H = src.hud
