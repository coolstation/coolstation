/datum/effects/system/foam_spread
	...
	var/temperature = T0C
	var/list/banned_reagents = list("smokepowder", "propellant", "thalmerite", "fluorosurfactant", "omegazine", "salt", "poor_concrete", "okay_concrete", "good_concrete", "perfect_concrete")
...
/datum/effects/system/foam_spread/proc/start()
	SPAWN_DBG(0)
		...
		playsound(F.loc, "sound/effects/bubbles2.ogg", 80, 1, SOUND_RANGE_MODERATE) //let's not play this from every single foam obj
