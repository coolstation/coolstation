...
/datum/controller/process/broadcasting
	...
	setup()
		...
		autoschedule_channels = list(TR_CAT_TEEVEE_BROADCAST_RECEIVERS, TR_CAT_TEEVEE_ALT_BROADCAST_RECEIVERS, TR_CAT_RADIO_BROADCAST_RECEIVERS, TR_CAT_RADIO_ALT_BROADCAST_RECEIVERS)
		...
		autoschedule_channels[TR_CAT_TEEVEE_ALT_BROADCAST_RECEIVERS] = scheduler
		autoschedule_channels[TR_CAT_RADIO_ALT_BROADCAST_RECEIVERS] = scheduler
