...
/datum/dialogueNode
	...
	syndicatecorpse8_scan
		...
		onActivate(var/client/C)
			playsound(C.mob.loc, "sound/machines/airlock_deny_temp.ogg", 50, 1,SOUND_RANGE_STANDARD)
			return
...
/datum/dialogueNode
	...
	sergeantscomputer_start
		...
		onActivate(var/client/C)
			playsound(C.mob.loc, "sound/effects/manta_interface.ogg", 50, 1,SOUND_RANGE_STANDARD)
...
/datum/dialogueNode
	...
	bustedmantapc_takeitem
		...
		onActivate(var/client/C)
			taken = 1
			playsound(C.mob.loc, "sound/items/Crowbar.ogg", 50, 1,SOUND_RANGE_STANDARD)
...
/datum/dialogueNode
	...
	polariscrate_open1
		...
		onActivate(var/client/C)
			...
			playsound(C.mob.loc, "sound/effects/polaris_crateopening.ogg", 50, 1, SOUND_RANGE_STANDARD)
