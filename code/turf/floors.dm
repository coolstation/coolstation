...
/turf/floor/plating/random
	New()
		...
		if (prob(2))
			...
			new /obj/decal/cleanable/dirt/dirt2(src)
		else if (prob(2))
			new /obj/decal/cleanable/dirt/dirt3(src)
		else if (prob(2))
			new /obj/decal/cleanable/dirt/dirt4(src)
		else if (prob(2))
			new /obj/decal/cleanable/dirt/dirt5(src)
		else if (prob(2))
		...
		if(AM.event_handler_flags & STAIR_ANIM && !AM.throwing)
			if(AM.dir & src.dir)
				...
				if (istype(AM, /obj/stool/chair))
					var/obj/stool/chair/W = AM
					if(W.stool_user)
						if(prob(W.stool_user.m_intent == "walk" ? 80 : 99))
							if(prob(20))
