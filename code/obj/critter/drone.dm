...
/obj/critter/gunbot/drone/miniature_syndie
	...
	select_target(var/atom/newtarget)
		..()
		playsound(src, (voice_gender == "male" ? "sound/voice/screams/male_scream.ogg" : "sound/voice/screams/female_scream.ogg"), 40, 1, SOUND_RANGE_STANDARD, 3, channel=VOLUME_CHANNEL_EMOTE)
