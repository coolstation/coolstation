						...
						if(!user.traitHolder.hasTrait("training_medical") && prob(15))
							...
							if(isalive(H) == false)
								...
								if(H.find_ailment_by_type(/datum/ailment/disease/respiratory_failure))
									...
									playsound(user, "sound/effects/cracklesstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/hyperventstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/distortedfasthyperstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/stridorstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/sleepstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL) // reusing because the sounds are similar
									...
									playsound(user, "sound/effects/sleepstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL) // reusing because the sounds are similar
								else if(H.reagents.has_reagent("epinephrine") || H.reagents.has_reagent("methamphetamine") || H.reagents.has_reagent("crank") || H.reagents.has_reagent("omegazine") || H.reagents.has_reagent("energydrink") )
									boutput(user, "<span style=\"color:blue\">You hear fast breathing inside [(user != H) ? "[H]'s" : "your"] lungs.</span>")
									playsound(user, "sound/effects/hyperventstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL) // reusing because the sounds are similar
									...
									if(H.get_oxygen_deprivation() < 60)
										...
										playsound(user, "sound/effects/hyperventstethoscope2.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/normstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
									...
									playsound(user, "sound/effects/sleepstethoscope.ogg", 40, 0, SOUND_RANGE_SMALL)
								else
