...
//todo: entirely new box type with labels, to complete pharmacy look
...
/obj/item/storage/box/purgativesbox
	name = "purgatives box"
	icon_state = "beaker"
...
/obj/item/storage/box/purgativebox
	name = "purgative box"
	icon_state = "beaker"
	desc = "A box containing bottles of calomel and space ipecac extract, for removal of harmful substances."
	spawn_contents = list(/obj/item/storage/pill_bottle/calomel = 4,\
	/obj/item/storage/pill_bottle/ipecac = 3)
