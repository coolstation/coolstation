...
/obj/item/clothing/mask/monkey_translator
	...
	desc = "Nanotechnology and questionable science combine to make a face-hugging translator, capable of making monkeys speak human langauge. Or whoever wears this."
