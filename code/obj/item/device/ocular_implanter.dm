...
/obj/item/device/ocular_implanter
	...
	proc/start_replace_eye(var/target, var/mob/living/carbon/human/H)
		...
		SPAWN_DBG(1 SECOND)
			playsound(H.loc, "sound/items/ocular_implanter_start", 50, 0, SOUND_RANGE_STANDARD)
	...
	proc/end_replace_eye(var/target, var/mob/living/carbon/human/H)
		if(!H)
			return
		playsound(H.loc, "sound/items/ocular_implanter_end", 50, 0, SOUND_RANGE_STANDARD)
		var/turf/T = H.loc
