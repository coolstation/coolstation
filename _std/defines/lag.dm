...
#define SLOW_LIFE_PLAYERCOUNT 30
/// whenn pcount is >= this number, slow Life() processing a lot
#define SLOWEST_LIFE_PLAYERCOUNT 50
...
// FUUUUUUUUUUTUREEEEEEEEEEEEEEE
#define CLIENTSIDE_TICK_LAG_FLUID 0.09

#define DEFAULT_CLICK_DELAY MIN_TICKLAG //used to be 1
#define CLICK_GRACE_WINDOW 0 //2.5

#define BASE_FIDDLE_DELAY 5 DECI SECONDS
