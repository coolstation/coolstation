...
#define GUN_NANO_FRIENDLY		GUN_NANO | GUN_JUICE | GUN_ITALIAN | GUN_RODEO
#define GUN_FOSS_FRIENDLY		GUN_FOSS
#define GUN_JUICE_FRIENDLY		GUN_NANO | GUN_JUICE | GUN_SOVIET | GUN_ITALIAN | GUN_RODEO
#define GUN_SOVIET_FRIENDLY		GUN_SOVIET | GUN_FOSS | GUN_ITALIAN
#define GUN_ITALIAN_FRIENDLY	GUN_NANO | GUN_JUICE | GUN_SOVIET | GUN_ITALIAN | GUN_RODEO
