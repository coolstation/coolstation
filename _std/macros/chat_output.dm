...
/*
I copied this over wholesale for the ease of porting Zamu's mail project from goon.
Someone apparently decided that things like
	boutput(user, "<span class='notice'>Apple pie.</span>")
were too prone to coder error, so everything's been converted to
	boutput(user, SPAN_NOTICE("Apple pie."))
instead. Personally I don't see the point. Just kinda obfuscates the existence of tags IMO.
Use it if you want, I guess.

No guarantees that any of the colours listed are accurate either.
