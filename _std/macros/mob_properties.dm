...
#define PROP_MOB_REFLECTPROT(x) x("reflection", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
#define PROP_MOB_ENCHANT_ARMOR(x) x("enchant_armor", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
//movement properties
...
#define PROP_MOB_SLIDEKICK_BONUS(x) x("slidekick_bonus", APPLY_MOB_PROPERTY_MAX, REMOVE_MOB_PROPERTY_MAX)
