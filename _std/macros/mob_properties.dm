...
//movement properties
#define PROP_EQUIPMENT_MOVESPEED(x) x("equipment_movespeed", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
#define PROP_EQUIPMENT_MOVESPEED_SPACE(x) x("equipment_movespeed_space", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
#define PROP_EQUIPMENT_MOVESPEED_FLUID(x) x("equipment_movespeed_fluid", APPLY_MOB_PROPERTY_SUM, REMOVE_MOB_PROPERTY_SUM)
...
#define PROP_SPACEFARTS(x) x("spacefarts", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
...
#define PROP_MOB_CAN_CONSTRUCT_WITHOUT_HOLDING(x) x("can_build_without_holding", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE) // mob can bulid furniture without holding them (for borgs)
